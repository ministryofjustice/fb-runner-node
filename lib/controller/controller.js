...
const initControllers = (componentDirs) => {
  controllers.page.type = require('./page-type-controllers')
  controllers.page.instance = require('./page-instance-controllers')
  controllers.component.type = require('./component-type-controllers')
