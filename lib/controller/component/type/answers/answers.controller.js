...
answersComponent.preUpdateContents = (componentInstance, userData, pageInstance) => {
  ...
  const formatAnswersValue = (value) => {
  ...
  while (nextPage) {
    ...
    if (!stepInstance.$skipPage) {
      ...
      if (sectionHeading) {
        sectionHeading = formatAnswersValue(sectionHeading)
        previousSectionHeading = formatAnswersValue(previousSectionHeading)
      ...
      if (names.length) {
        ...
        if (pageHeading) {
          pageHeading = formatAnswersValue(pageHeading)
          const pageAnswers = {
            heading: pageHeading,
      ...
      names.forEach(nameInstance => {
        ...
        question = formatAnswersValue(question)
