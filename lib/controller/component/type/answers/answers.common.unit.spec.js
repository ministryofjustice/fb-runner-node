...
test('Populating the answer bucket for a checkboxes component', (t) => {
  getUrlStub.reset()
  getDisplayValueStub.reset()
  striptagsStub.reset()
  ...
  t.deepEqual(getUrlStub.firstCall.args, ['page id', 'params', 'default content lang'], 'gets the url')
  t.deepEqual(answerBucketStub.push.firstCall.args[0], populateCheckboxesAnswerBucketExpectedData, 'populates the answers array')
