...
const getDisplayValueForItemStub = sinon.stub()
const formatStub = sinon.stub()

const mockComponentController = {
  getDisplayValue: getDisplayValueStub,
  getDisplayValueForItem: getDisplayValueForItemStub
}
const getComponentControllerStub = sinon.stub().returns(mockComponentController)
...
const {
  ...
  '~/fb-runner-node/controller/component/get-component-controller': getComponentControllerStub
})
...
test('Populating the answer bucket', (t) => {
  ...
  const questionInstance = {name: 'component name', label: 'component label', value: 'component value'}
  ...
  const userDataStub = {
    ...
    getUserDataInputProperty: sinon.stub().returns('user data input property')
  }
...
test('Populating the answer bucket for a file upload component when a file has not been uploaded', (t) => {
  ...
  const userDataStub = {
    ...
    getUserDataInputProperty: sinon.stub().returns(undefined)
  }
  const pageInstance = {url: '/page-url'}
...
test('Populating the answer bucket for a checkboxes component with a value', (t) => {
  getUrlStub.reset()
  getDisplayValueStub.reset()
  getDisplayValueForItemStub.reset()
  striptagsStub.reset()
  ...
  getUrlStub.returns('page-url')
  getDisplayValueStub.returns('display value')
  getDisplayValueForItemStub.returns('display value')
  striptagsStub.returns('stripped text')
...
test('Getting the question text in the default language from the question instance label', (t) => {
  ...
  const userData = {contentLang: 'content language'}
...
test('Getting the heading text in the default language', (t) => {
  ...
  const headingText = getHeadingText(questionInstance, userData)
...
test('Getting the visually hidden text in the default language', (t) => {
  ...
  const visuallyHiddenText = getVisuallyHiddenText(questionInstance, userData)
