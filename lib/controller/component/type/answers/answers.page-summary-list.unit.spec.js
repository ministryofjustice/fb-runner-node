...
test('when invoking the answers component', async t => {
  ...
  t.deepEqual(populateAnswerBucketStub.getCall(0).args, [
    ...
    userDataStub,
    pageInstance
  ], 'calls `populateAnswerBucket` with the expected arguments (1)')
  ...
  t.deepEqual(populateAnswerBucketStub.getCall(1).args, [
    ...
    userDataStub,
    pageInstance
  ], 'calls `populateAnswerBucket` with the expected arguments (2)')
  ...
  t.deepEqual(populateAnswerBucketStub.getCall(2).args, [
    ...
    userDataStub,
    pageInstance
  ], 'calls `populateAnswerBucket` with the expected arguments (3)')
  ...
  t.deepEqual(populateAnswerBucketStub.getCall(3).args, [
    ...
    userDataStub,
    pageInstance
  ], 'calls `populateAnswerBucket` with the expected arguments (4)')
  ...
  t.deepEqual(populateAnswerBucketStub.getCall(4).args, [
    ...
    userDataStub,
    pageInstance
  ], 'calls `populateAnswerBucket` with the expected arguments (5)')
