...
test('Answers component', async t => {
  ...
  const questionInstancesPage2 = [
    ...
    {
      _id: 'page id 2 item 5',
      _type: 'mojFileupload',
      name: 'component name item 5',
      multiline: true
    }
  ]
  ...
  t.equal(populateAnswerBucketStub.callCount, 6, 'calls `populateAnswerBucket` six times')
  ...
  t.deepEqual(populateAnswerBucketStub.getCall(4).args, [
    ...
    userDataStub,
    pageInstance
  ], 'calls `populateAnswerBucket` with the expected arguments (question instances page 2, fileupload component)')

  t.deepEqual(populateAnswerBucketStub.getCall(5).args, [
    answerBucket,
    questionInstanceFive,
    componentInstance,
    subsequentPage2,
    ...
    userDataStub,
    pageInstance
  ], 'calls `populateAnswerBucket` with the expected arguments (question instances page 2, mojFileupload component)')
