...
const getComponentController = require('~/fb-runner-node/controller/component/get-component-controller')
      ...
      if (!currentInstance.$skipPage) {
        ...
        if (currentInstance._type !== 'page.singlequestion') {
          ...
          if (hasQuestions(questionInstances)) {
            ...
            if (pageHeading) {
              pageHeading = getHeadingText(currentInstance, userData)
        ...
        questionInstances.forEach(questionInstance => {
          ...
          const displayValue = controller.getDisplayValue(questionInstance, userData) // getDisplayValue(pageInstance, userData, questionInstance)
