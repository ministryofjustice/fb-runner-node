...
const getCompositeStub = sinon.stub()
const getComponentControllerStub = sinon.stub().returns({
...
test('An instance has a composite', (t) => {
  const hasStub = sinon.stub(Reflect, 'has').returns(true)
  const getStub = sinon.stub(Reflect, 'get').returns('mock component instance type')
...
test('An instance does not have a composite', (t) => {
  const hasStub = sinon.stub(Reflect, 'has')
