...
SummaryController.preFlight = async (pageInstance, userData) => {
  ...
  if (performsSubmit) {
    ...
    let reachedPageInstance = getInstance('page.start')
    reachedPageInstance = produce(reachedPageInstance, draft => {
      draft.changepage = currrentUrl
