...
test.skip('it attaches a user submission when the property is set to true', async t => {
...
test.skip('it does not attach a user submission when the property is set to false', async t => {
  getUserDataPropertyStub.resetHistory()
  getUserDataPropertyStub.withArgs('email').returns('user@example.com')
...
test.skip('it attaches json to submission when env var present', async t => {
  getUserDataPropertyStub.resetHistory()
...
test.skip('when there are files it attaches them to json submission', async t => {
  getUserDataPropertyStub.resetHistory()
...
test.skip('it does not attach json to submission when env var not present', async t => {
  getUserDataPropertyStub.resetHistory()
...
test.skip('TEAM PDF: it attaches PDF contents to email submission attachments', async t => {
  getUserDataPropertyStub.resetHistory()
...
test.skip('USER PDF: it attaches PDF contents to email submission attachments', async t => {
  getUserDataPropertyStub.resetHistory()
  getUserDataPropertyStub.resetBehavior()
