...
const {NUNJUCKS_NOCACHE, NUNJUCKS_WATCH, EDITABLE, SERVICE_SLUG, SERVICE_TOKEN, SERVICE_SECRET, USER_DATASTORE_URL, SUBMITTER_URL, FORM_URL} = processEnv
...
let {FQD, SAVE_RETURN_URL, EMAIL_URL, SMS_URL} = processEnv
FQD = FQD || FORM_URL
SAVE_RETURN_URL = SAVE_RETURN_URL || USER_DATASTORE_URL
EMAIL_URL = EMAIL_URL || SUBMITTER_URL
SMS_URL = SMS_URL || SUBMITTER_URL
