...
// This value should be ~X.X.X-1
// where X.X.X maps to version of govuk-frontend used by fb-components-core
// -1 suffix allows latest published version matching ~X.X.X-*
const COMPONENTS_VERSION = '~3.1.0-2'
...
COMPONENTS_MODULE
  default components module to use (@ministryofjustice/fb-components-core)

COMPONENTS_VERSION
  version of components module to use
