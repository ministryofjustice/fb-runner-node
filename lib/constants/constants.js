...
const {NUNJUCKS_NOCACHE, NUNJUCKS_WATCH, EDITABLE, SERVICE_SLUG, SERVICE_TOKEN, SERVICE_SECRET, USER_DATASTORE_URL, SUBMITTER_URL, FORM_URL, PLATFORM_ENV, DEPLOYMENT_ENV} = processEnv
