...
test('When the COMPONENTS_MODULE ENV variable is set', t => {
  t.equal(constants.COMPONENTS_MODULE, 'components-module', 'constants should set COMPONENTS_MODULE to that value')
  t.end()
})

test('When the COMPONENTS_VERSION ENV variable is set', t => {
  t.equal(constants.COMPONENTS_VERSION, '2.0.0', 'constants should set COMPONENTS_VERSION to that value')
  t.end()
})
