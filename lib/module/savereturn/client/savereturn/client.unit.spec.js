...
const FBUserDataStoreClient = proxyquire('./client', {
...
test('When instantiating save and return client without a service slug', t => {
  testInstantiation(t, [serviceSecret], 'ENOSERVICESLUG', 'No service slug passed to client')
})

test('When instantiating save and return client without a save and return url', t => {
  testInstantiation(t, [serviceSecret, serviceSlug], 'ENOMICROSERVICEURL', 'No microservice url passed to client')
})

test('When instantiating save and return client without a service secret', t => {
  testInstantiation(t, [undefined, serviceSlug, saveReturnUrl], 'ENOSERVICESECRET', 'No service secret passed to client')
})

// Set up a client to test the methods
const saveReturnClient = new FBUserDataStoreClient(serviceSecret, serviceSlug, saveReturnUrl)
