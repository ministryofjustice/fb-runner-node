...
const getMessage = (_id, userData, dataArgs = {}, personalisation = {}) => {
  console.log('\n\n\n\n==================\n\n\n\n')
  console.log('getMessage: dataArgs', JSON.stringify(dataArgs, null, 2))
  console.log('getMessage: userData.getScopedUserData()', JSON.stringify(userData.getScopedUserData(), null, 2))
  console.log('\n\n\n\n==================\n\n\n\n')
...
const sendEmail = async (_id, userData, dataArgs = {}, personalisation = {}) => {
  console.log('\n\n\n\n==================\n\n\n\n')
  console.log('sendEmail: dataArgs', JSON.stringify(dataArgs, null, 2))
  console.log('\n\n\n\n==================\n\n\n\n')
