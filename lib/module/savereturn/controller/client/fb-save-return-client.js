...
class FBSaveReturnClient extends FBJWTClient {
   ...
   *
   **/
  async createSetupEmailToken (userId, userToken, email, message) {
   ...
   *
   **/
  async createSetupMobileCode (userId, userToken, email, mobile, message) {
    const encryptedDetails = {
      userId,
      userToken,
      email,
   ...
   * @return {promise<object>}
   **/
  async createRecord (userId, userToken, email, mobile, message) {
    const encryptedDetails = {
      userId,
      userToken,
      email
   ...
   * @return {promise<object>}
   **/
  async createMagiclink (email, message) {
    const payload = {
      email: message,
      encrypted_email: email
    }
   ...
   *
   **/
  async createSigninMobileCode (email, message) {
