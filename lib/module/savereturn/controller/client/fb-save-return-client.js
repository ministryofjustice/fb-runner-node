...
class FBSaveReturnClient extends FBJWTClient {
   ...
   * Variables to use in email template
   *
   * @return {promise<object>}
   *
   **/
  async createSetupEmailToken (userId, userToken, email, validationUrl, templateContext) {
   ...
   * @return {promise<object>}
   **/
  async createMagiclink (email, validationUrl, templateContext) {
    const payload = {
      email,
      encrypted_email: email,
      validation_url: validationUrl,
