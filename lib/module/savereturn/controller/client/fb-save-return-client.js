...
class FBSaveReturnClient extends FBJWTClient {
   ...
   *
   **/
  constructor (serviceSecret, serviceToken, serviceSlug, saveReturnUrl, options = {}) {
    super(serviceSecret, serviceToken, serviceSlug, saveReturnUrl, SaveReturnClientError, options)
  }
