...
const { SERVICE_SLUG, SAVE_RETURN_URL, SERVICE_SECRET } = require('~/fb-runner-node/constants/constants')
...
if (SAVE_RETURN_URL) {
  saveReturnClient = new FBSaveReturnClient(SERVICE_SECRET, SERVICE_SLUG, SAVE_RETURN_URL)
}
