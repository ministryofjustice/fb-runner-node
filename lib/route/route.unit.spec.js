...
const workingTests = [
  ...
  {input: {_id: 'v', params: {v: 1}}, userData, output: {_id: 'v.add'}},

  {input: {_id: 'v.add'}, userData, output: {_id: 'w', params: {w: 1}}},
  ...
  {input: {_id: 'v', params: {v: 2}}, userData: userDataDefined, output: {_id: 'v.add'}},
  {input: {_id: 'v.add'}, userData: userDataDefined, output: {_id: 'w', params: {w: 1}}},
