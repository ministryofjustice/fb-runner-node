...
const getNextPage = (_id, userData) => {
  const nextPageId = getNextPageWorkhorse(_id, userData)
...
const getNextPageWorkhorse = (_id, userData) => {
  // Does the page have steps?
  ...
  return checkCurrentPage(_id, userData)
}

const getPreviousPage = (_id, userData) => {
  const previousPageId = getPreviousPageWorkhorse(_id, userData)
...
const getPreviousPageWorkhorse = (_id, userData) => {
  const checkCurrentPage = (currentId, userData) => {
    // Is the page a repeatable instance?
    const repeatable = getInstanceProperty(currentId, 'repeatable', {})
    if (repeatable.active) {
