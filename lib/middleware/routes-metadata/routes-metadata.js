...
const pageHandler = async (req, res) => {
  ...
  if (!handlerData) {
    ...
    if (pageController.preUpdateContents) {
      console.log('pageInstance._id A', pageInstance._id)
      pageInstance = await pageController.preUpdateContents(pageInstance, userData)
      console.log('pageInstance._id B', pageInstance ? pageInstance._id : 'Not defoined')
    ...
    for await (let componentInstance of componentInstances) {
      ...
      if (componentInstanceController.preUpdateContents) {
        componentInstance = await componentInstanceController.preUpdateContents(componentInstance, userData, pageInstance)
      }
    }
