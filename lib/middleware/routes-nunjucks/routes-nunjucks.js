...
function init () {
  return router.use(/^\/([^.]+)$/, (req, res, next) => {
    ...
    /*
     *  1. This definsiveness is probably unecessary
     *  2. This is an object with a field key which is a number. Here `0` isn't an array index,
     *  but this works as well whether `req.params` is an array or an object
     */
