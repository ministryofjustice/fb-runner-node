...
test('When metrics endpoint is called', t => {
  ...
  promsterGetContentTypeStub.resolves('metrics-content-type')
  const promsterGetSummaryStub = stub(promster, 'getSummary')
  promsterGetSummaryStub.resolves('metrics-summary')
  ...
  t.ok(resSetHeaderStub.calledOnce, 'it should call res.setHeader once')
