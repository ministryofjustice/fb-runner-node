...
test.only('When getInstanceTitle is invoked', t => {
  const getServiceInstancesStub = getStubbedServiceInstances()
  t.equal(getInstanceTitle('x'), undefined, 'it should return undefined for a missing instance')
  t.equal(getInstanceTitle('a'), 'a', 'it should fallback to the _id when no other title can be found')
