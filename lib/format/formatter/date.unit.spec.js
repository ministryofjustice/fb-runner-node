...
test('When formatting ISO date strings as time', t => {
  const formattedStringISO = formatDate('2018-12-03T21:26:25.761Z', {format: 'HH:mm'})
  t.equal(formattedStringISO, '22:26', 'it should return the correctly formatted time string')
  t.end()
})
