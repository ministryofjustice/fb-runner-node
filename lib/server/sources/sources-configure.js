...
const configureSources = async (options = {}) => {
  ...
  serviceSources.push({
    source: '@ministryofjustice/fb-components/components-core',
    sourcePath: path.resolve(process.env.PWD, 'node_modules/@ministryofjustice/fb-components/components-core')
  })
