...
test('When configuring sources', async t => {
  ...
  t.deepEqual(serviceSources, [
    ...
    {source: '@ministryofjustice/fb-components/components-core', sourcePath: path.resolve(process.env.PWD, 'node_modules/@ministryofjustice/fb-components/components-core')},
