...
test('When performing preinstallation tasks for the service sources', async t => {
  ...
  t.deepEqual(ensurePackageStub.getCall(0).args, ['service_package_path', 'components_version', 'components_modules'], 'it should pass the expected args to ensurePackage')
