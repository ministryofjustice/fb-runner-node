...
test('The `accept` property is not present (upload)', async t => {
  const {
    files
  } = await processUploadedFiles(uploadedFiles, uploadControl)
...
test('The `accept` property is an array (upload)', async t => {
  ...
  const {
    files
  } = await processUploadedFiles(uploadedFiles, uploadControlWithoutAccept)
...
test('The `accept` property is an array of mimetypes (upload)', async t => {
  ...
  } = await processUploadedFiles(uploadedFiles, uploadControlWithAccept)
...
test('When an uploaded file is valid', async t => {
...

  {
    const {
      files,
      fileErrors
    } = await processUploadedFiles(uploadedFilesWithoutFileErrors, uploadControl)
...

  {
    const {
      files,
      fileErrors
    } = await processUploadedFiles(uploadedFilesWithErrors, uploadControl)
