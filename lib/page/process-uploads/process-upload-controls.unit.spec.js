...
test('`processUploadControls` is called (mojUpload)', async t => {
  const userData = {
    req: {
      body: {}
    },
...
test('Removing an upload (mojUpload) ', async t => {
  const userData = getUserDataMethods({})
  userData.req = {
    body: {}
  }
...
test('Removing an upload when a property has multiple uploads (mojUpload)', async t => {
  const userData = getUserDataMethods({})
  userData.req = {
    body: {}
  }
...
test('Trying to remove an upload which does not exist (mojUpload)', async t => {
  const userData = getUserDataMethods({})
  userData.req = {
    body: {}
  }
