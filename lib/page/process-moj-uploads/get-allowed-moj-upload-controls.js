...
const {getUploadMaxFiles, getUploadFileCount} = require('~/fb-runner-node/page/utils/utils-uploads')

const getAllowedMOJUploadControls = (userData, uploadControls) => {
...
module.exports = getAllowedMOJUploadControls
