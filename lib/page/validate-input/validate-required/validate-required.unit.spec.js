...
const {
  ...
  '~/fb-runner-node/controller/component/get-component-composite': getComponentCompositeStub
})
...
test('When checking whether a composite instance with a conttroller has an error', t => {
  getComponentCompositeStub.returns(['x', 'y'])
  const getServiceSchemaStub = stub(validateRequired, 'getServiceSchema')
  getServiceSchemaStub.callsFake(() => {
    return {
