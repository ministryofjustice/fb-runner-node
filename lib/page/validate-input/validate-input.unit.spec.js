...
test('When validating a page instance that has no errors', t => {
  ...
  const requiredPageInstance = normalisePageInstance(validateRequiredArgs[0])
  ...
  const valuePageInstance = normalisePageInstance(validateValueArgs[0])
  t.deepEqual(valuePageInstance, pageInstance, 'it should pass the pageInstance to validateValue method')
