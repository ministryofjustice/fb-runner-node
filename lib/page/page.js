...
const getRedirectForNextPage = require('./redirect-next-page/redirect-next-page')
const getRedirectForPreviousPage = require('./redirect-previous-page/redirect-previous-page')
const getRedirectFromPageToPage = require('./redirect-from-page-to-page/redirect-from-page-to-page')
