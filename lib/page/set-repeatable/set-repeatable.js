  ...
  pageInstance = produce(pageInstance, draft => {
    ...
    const propagateModelsRepeatable = (instance, parent, prop, parentIndex) => {
      ...
      if (instance.repeatable) {
        ...
        const components = []
        instances = []
        const instanceTitle = getInstanceLangProperty(instance._id, 'label', pageInstance.contentLang) || getInstanceLangProperty(instance._id, 'legend', pageInstance.contentLang)
        ...
        for (let count = 1; count <= instanceCount; count++) {
          ...
          if (instanceCount && instanceCount !== 1) {
            ...
            instanceCopy[titleProp] = `${instanceTitle} ${count}`
          ...
          instanceCopy.repeatableDelete = format(instanceCopy.repeatableDelete, {label: instanceTitle, count})
        ...
        if (!instance.repeatableMaximum || instanceCount < instance.repeatableMaximum) {
          ...
          addHtml = format(addHtml, {label: instanceTitle})
