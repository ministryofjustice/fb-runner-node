...
test('When updating a page', t => {
  ...
  const componentsProps = formatProperties({components: [{
    _type: 'foo',
    heading: '{x}'
  }, {
    _type: 'bar',
  ...
  t.deepEqual(componentsProps, {components: [{
    _type: 'foo',
    heading: 'value'
  }, {
    _type: 'bar',
  ...
  const pageInstanceWithDefaultValueProps = formatProperties({
    _type: 'defaultTypeSchema',
    defaultTest: undefined
  }, userData())
  t.deepEqual(pageInstanceWithDefaultValueProps.defaultTest, 'defaultTest default value', 'it should use the default value when no value specified')

  const pageInstanceWithSpecifiedValueProps = formatProperties({
    _type: 'defaultTypeSchema',
    defaultTest: 'specified value'
  }, userData())
  t.deepEqual(pageInstanceWithSpecifiedValueProps.defaultTest, pageInstanceWithSpecifiedValueProps.defaultTest, 'it should not overwrite specified values with default ones')
