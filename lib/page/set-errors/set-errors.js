...
const getErrorArgs = (controlInstance = {}, error, lang) => {
  ...
  let control = controlInstance[`label:${lang}`] || (controlInstance.label ? controlInstance.label.html : controlInstance.label)
  if (!control) {
    control = controlInstance[`legend:${lang}`] || (controlInstance.legend ? controlInstance.legend.html : controlInstance.legend)
  }
...
external.setSummaryError = (pageInstance, controlInstance, errorType, error) => {
  ...
  let href = `#${controlInstance.id || controlInstance._id}`
