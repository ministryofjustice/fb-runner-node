...
test('When setting summary errors repeatedly', t => {
  ...
  }, 'it should set not add other errors if a required error has already been registered for the component')

  t.deepEqual(errorList[1], {
    html: 'minimum', href: '#control2'
  }, 'it should set not add required errors if any error has already been registered for the component')
