...
const skipPage = require('~/page/skip-page/skip-page')
const setControlNames = require('~/page/set-control-names/set-control-names')
const setComposite = require('~/page/set-composite/set-composite')
const setRepeatable = require('~/page/set-repeatable/set-repeatable')
