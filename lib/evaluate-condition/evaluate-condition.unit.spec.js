...
const all = {
  passing: {
    all: deepClone(allPassing)
  },
  failing: {
    all: deepClone(twoPassing)
  }
}

const any = {
  passing: {
    any: deepClone(onePassing)
  },
  failing: {
    any: deepClone(nonePassing)
  },
  additional: {
    'it should return true when more than one condition is met': {
      any: deepClone(twoPassing)
    },
    'it should return true when all conditions are met': {
      any: deepClone(allPassing)
    }
  },
  additionalFailing: {
...
const exactly = {
  passing: {
    exactly: deepClone(onePassing)
  },
  failing: {
    exactly: deepClone(nonePassing)
  },
  additional: {
    'it should return true when number of conditions specified is met': {
      exactly: deepClone(twoPassing),
      conditionsMet: 2
    }
  },
  additionalFailing: {
